...
<div class="main-header">
    ...
    <p>Tác giả: Phùng Thị Hưng - Trường Tiểu học Hùng An - ĐT: 0857 394 435</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phùng Thị Hưng - Trường Tiểu học Hùng An - ĐT: 0857 394 435 </div>", unsafe_allow_html=True)
